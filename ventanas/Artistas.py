...
class ArtistasVentana(QMainWindow):
    def __init__(self, ventana_principal=None):
        ...
        self.txtBiografia.setValidator(validator_biografia)
    ...
    def exportar_pdf(self) -> None:
        guardar_pdf(self, "Gestión de Artistas", "artistas.pdf",
                    html_tabla_widget(self.table, "LISTADO DE ARTISTAS"))

    def vista_previa_pdf(self) -> None:
        vista_previa_pdf(self, "Gestión de Artistas", "artistas.pdf",
                         html_tabla_widget(self.table, "LISTADO DE ARTISTAS"))
